...
static const FT_Glyph_Metrics *
ImGui_ImplFreeType_LoadGlyph(ImGui_ImplFreeType_FontSrcData *src_data, uint32_t codepoint)
{
...
static void
ImGui_ImplFreeType_BlitGlyph(const FT_Bitmap *ft_bitmap, uint32_t *dst, uint32_t dst_pitch)
{
...
static bool
ImGui_ImplFreeType_LoaderInit(ImFontAtlas *atlas)
{
    ...
    snprintf(GImGuiFreeTypeLoaderName,
             sizeof(GImGuiFreeTypeLoaderName),
             "FreeType (%d.%d.%d; %d.%d.%d)",
             FREETYPE_MAJOR,
             FREETYPE_MINOR,
             FREETYPE_PATCH,
             ver_linked_major,
...
static void
ImGui_ImplFreeType_LoaderShutdown(ImFontAtlas *atlas)
{
...
static bool
ImGui_ImplFreeType_FontSrcInit(ImFontAtlas *atlas, ImFontConfig *src)
{
    ImGui_ImplFreeType_Data        *bd           = (ImGui_ImplFreeType_Data *)atlas->FontLoaderData;
...
static void
ImGui_ImplFreeType_FontSrcDestroy(ImFontAtlas *atlas, ImFontConfig *src)
{
    IM_UNUSED(atlas);
...
static bool
ImGui_ImplFreeType_FontBakedInit(ImFontAtlas  *atlas,
                                 ImFontConfig *src,
                                 ImFontBaked  *baked,
...
static void
ImGui_ImplFreeType_FontBakedDestroy(ImFontAtlas  *atlas,
                                    ImFontConfig *src,
                                    ImFontBaked  *baked,
                                    void         *loader_data_for_baked_src)
{
...
static bool
ImGui_ImplFreeType_FontBakedLoadGlyph(ImFontAtlas  *atlas,
                                      ImFontConfig *src,
                                      ImFontBaked  *baked,
                                      void         *loader_data_for_baked_src,
                                      ImWchar       codepoint,
...
static bool
ImGui_ImplFreetype_FontSrcContainsGlyph(ImFontAtlas *atlas, ImFontConfig *src, ImWchar codepoint)
{
    IM_UNUSED(atlas);
    ImGui_ImplFreeType_FontSrcData *bd_font_data
        = (ImGui_ImplFreeType_FontSrcData *)src->FontLoaderData;
...
{
    bool edited = false;
    edited |= ImGui::CheckboxFlags(
        "NoHinting", p_font_loader_flags, ImGuiFreeTypeLoaderFlags_NoHinting);
    edited |= ImGui::CheckboxFlags(
        "NoAutoHint", p_font_loader_flags, ImGuiFreeTypeLoaderFlags_NoAutoHint);
    edited |= ImGui::CheckboxFlags(
        "ForceAutoHint", p_font_loader_flags, ImGuiFreeTypeLoaderFlags_ForceAutoHint);
    edited |= ImGui::CheckboxFlags(
        "LightHinting", p_font_loader_flags, ImGuiFreeTypeLoaderFlags_LightHinting);
    edited |= ImGui::CheckboxFlags(
        "MonoHinting", p_font_loader_flags, ImGuiFreeTypeLoaderFlags_MonoHinting);
    ...
    edited |= ImGui::CheckboxFlags(
        "Monochrome", p_font_loader_flags, ImGuiFreeTypeLoaderFlags_Monochrome);
    edited |= ImGui::CheckboxFlags(
        "LoadColor", p_font_loader_flags, ImGuiFreeTypeLoaderFlags_LoadColor);
