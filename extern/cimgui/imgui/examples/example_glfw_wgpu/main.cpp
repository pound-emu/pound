...
// GLFW helper to create a WebGPU surface, used only in WGPU-Native. DAWN-Native already has a
// built-in function As of today (2025/10) there is no "official" support in GLFW to create a
// surface for WebGPU backend This stub uses "low level" GLFW calls to acquire information from a
// specific Window Manager. Currently supported platforms: Windows / Linux (X11 and Wayland) /
// MacOS. Not necessary nor available with EMSCRIPTEN.
#ifndef __EMSCRIPTEN__
...
WGPUSurface
CreateWGPUSurface(const WGPUInstance &instance, GLFWwindow *window)
{
