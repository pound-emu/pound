...
static void
CleanupVulkanWindow(ImGui_ImplVulkanH_Window *wd)
{
...
// FIXME: This code would ideally be inside imgui_impl_win32.cpp, it would create a dependency on
// Vulkan headers in imgui_impl_win32.cpp
static int
ImGui_ImplWin32_CreateVkSurface(ImGuiViewport *viewport,
                                ImU64          vk_instance,
                                ...
                                ImU64         *out_vk_surface)
{
    ...
    return (int)vkCreateWin32SurfaceKHR((VkInstance)vk_instance,
                                        &createInfo,
