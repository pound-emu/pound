...
static void
Hook_Renderer_CreateWindow(ImGuiViewport *viewport)
{
...
static void
Hook_Renderer_DestroyWindow(ImGuiViewport *viewport)
{
...
static void
Hook_Platform_RenderWindow(ImGuiViewport *viewport, void *)
{
...
static void
Hook_Renderer_SwapBuffers(ImGuiViewport *viewport, void *)
{
    if (WGL_WindowData *data = (WGL_WindowData *)viewport->RendererUserData)
    {
...
main(int, char **)
{
    ...
    while (!done)
    {
        ...
        if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
        {
            ...
            // Restore the OpenGL rendering context to the main window DC, since platform windows
