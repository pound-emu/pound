...
// For imgui_impl_null: use relative filename + embed implementation directly by including the .cpp
// file. This is to simplify casual building of this example from all sorts of test scripts.
