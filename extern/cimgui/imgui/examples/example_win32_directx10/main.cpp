...
{
    // Setup swap chain
    // This is a basic setup. Optimally could use handle fullscreen mode differently. See #8979 for
    // suggestions.
    ...
    // - This must be done for all windows associated to the device. Our DX11 backend does this
    // automatically for secondary viewports that it creates.
