...
// (Advanced, for X11 users) Override Mouse Capture mode. Mouse capture allows receiving updated
// mouse position after clicking inside our window and dragging outside it. Having this 'Enabled' is
// in theory always better. But, on X11 if you crash/break to debugger while capture is active you
// may temporarily lose access to your mouse. The best solution is to setup your debugger to
// automatically release capture, e.g. 'setxkbmap -option grab:break_actions && xdotool key
// XF86Ungrab' or via a GDB script. See #3650. But you may independently decide on X11, when a
// debugger is attached, to set this value to ImGui_ImplSDL2_MouseCaptureMode_Disabled.
enum ImGui_ImplSDL2_MouseCaptureMode
{
