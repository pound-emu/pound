...
//  2026-04-23: DirectX10: Added support for standard draw callbacks (in platform_io):
//  DrawCallback_ResetRenderState, DrawCallback_SetSamplerLinear, DrawCallback_SetSamplerNearest.
//  Obsoleting samplers from ImGui_ImplDX10_RenderState. (#9378) 2026-01-19: DirectX10: Added
//  'SamplerNearest' in ImGui_ImplDX10_RenderState. Renamed 'SamplerDefault' to 'SamplerLinear'.
...
// Draw callbacks
static void
ImGui_ImplDX10_DrawCallback_ResetRenderState(const ImDrawList *, const ImDrawCmd *)
{
} // Intentionally empty. Used as an identifier for rendering loop to call its code. Simpler to
  // implement this way.
static void
ImGui_ImplDX10_DrawCallback_SetSamplerLinear(const ImDrawList *, const ImDrawCmd *)
{
    ImGui_ImplDX10_Data *bd = ImGui_ImplDX10_GetBackendData();
    bd->pd3dDevice->PSSetSamplers(0, 1, &bd->pTexSamplerLinear);
}
static void
ImGui_ImplDX10_DrawCallback_SetSamplerNearest(const ImDrawList *, const ImDrawCmd *)
{
    ImGui_ImplDX10_Data *bd = ImGui_ImplDX10_GetBackendData();
    bd->pd3dDevice->PSSetSamplers(0, 1, &bd->pTexSamplerNearest);
}
...
static void
ImGui_ImplDX10_DestroyTexture(ImTextureData *tex)
{
...
void
ImGui_ImplDX10_UpdateTexture(ImTextureData *tex)
{
    ImGui_ImplDX10_Data *bd = ImGui_ImplDX10_GetBackendData();
    ...
    else if (tex->Status == ImTextureStatus_WantUpdates)
    {
        ...
        for (ImTextureRect &r : tex->Updates)
        {
            ...
            bd->pd3dDevice->UpdateSubresource(backend_tex->pTexture,
                                              0,
                                              &box,
...
static void
ImGui_ImplDX10_CreateWindow(ImGuiViewport *viewport)
{
    ImGui_ImplDX10_Data         *bd = ImGui_ImplDX10_GetBackendData();
...
static void
ImGui_ImplDX10_DestroyWindow(ImGuiViewport *viewport)
{
    // The main viewport (owned by the application) will always have RendererUserData == 0 here
...
static void
ImGui_ImplDX10_SetWindowSize(ImGuiViewport *viewport, ImVec2 size)
{
    ImGui_ImplDX10_Data         *bd = ImGui_ImplDX10_GetBackendData();
...
static void
ImGui_ImplDX10_RenderViewport(ImGuiViewport *viewport, void *)
{
    ImGui_ImplDX10_Data         *bd = ImGui_ImplDX10_GetBackendData();
    ImGui_ImplDX10_ViewportData *vd = (ImGui_ImplDX10_ViewportData *)viewport->RendererUserData;
...
static void
ImGui_ImplDX10_SwapBuffers(ImGuiViewport *viewport, void *)
{
    ImGui_ImplDX10_ViewportData *vd = (ImGui_ImplDX10_ViewportData *)viewport->RendererUserData;
    if (vd->SwapChain)
    {
