...
//  [ ] Renderer: Missing support for DrawCallback_SetSamplerLinear, DrawCallback_SetSamplerNearest
//  callbacks: SDLRenderer2 does not support changing SDL_SCALE_MODE while rendering.
...
//  DrawCallback_ResetRenderState (others cannot be supported). (#9378) 2026-03-12: Fixed invalid
//  assert in ImGui_ImplSDLRenderer2_UpdateTexture() if ImTextureID_Invalid is defined to be != 0,
//  which became the default since 2026-03-12. (#9295) 2025-09-18: Call
...
//  ImGui_ImplSDLRenderer2_CreateFontsTexture() and ImGui_ImplSDLRenderer2_DestroyFontsTexture().
...
// Draw callbacks
static void
ImGui_ImplSDLRenderer2_DrawCallback_ResetRenderState(const ImDrawList *, const ImDrawCmd *)
{
...
ImGui_ImplSDLRenderer2_UpdateTexture(ImTextureData *tex)
{
    ...
    if (tex->Status == ImTextureStatus_WantCreate)
    {
        ...
        SDL_Texture *sdl_texture = SDL_CreateTexture(bd->Renderer,
