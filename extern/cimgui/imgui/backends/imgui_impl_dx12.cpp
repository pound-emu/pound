...
//  (#9378) 2025-10-23: [Docking] DirectX12: Fixed an issue in synchronization logic improving
//  rendering throughput for secondary viewports. (#8961, #9025) 2025-10-11: DirectX12: Reuse
//  texture upload buffer and grow it only when necessary. (#9002) 2025-09-29: DirectX12: Rework
//  synchronization logic. (#8961) 2025-09-29: DirectX12: Enable swapchain tearing to eliminate
//  viewports framerate throttling. (#8965) 2025-09-29: DirectX12: Reuse a command list and
//  allocator for texture uploads instead of recreating them each time. (#8963) 2025-09-18: Call
//  platform_io.ClearRendererHandlers() on shutdown. 2025-06-19: Fixed build on MinGW. (#8702,
//  #4594) 2025-06-11: DirectX12: Added support for ImGuiBackendFlags_RendererHasTextures, for
//  dynamic font atlas. 2025-05-07: DirectX12: Honor draw_data->FramebufferScale to allow for custom
//  backends and experiment using it (consistently with other renderer backends, even though in
//  normal condition it is not set under Windows). 2025-02-24: DirectX12: Fixed an issue where
//  ImGui_ImplDX12_Init() signature change from 2024-11-15 combined with change from 2025-01-15 made
//  legacy ImGui_ImplDX12_Init() crash. (#8429) 2025-01-15: DirectX12: Texture upload use the
//  command queue provided in ImGui_ImplDX12_InitInfo instead of creating its own. 2024-12-09:
//  DirectX12: Let user specifies the DepthStencilView format by setting
//  ImGui_ImplDX12_InitInfo::DSVFormat. 2024-11-15: DirectX12: *BREAKING CHANGE* Changed
//  ImGui_ImplDX12_Init() signature to take a ImGui_ImplDX12_InitInfo struct. Legacy
...
// field. Secondary viewports created by this backend will use all the fields (including Window
// fields),
...
// Functions
static void
ImGui_ImplDX12_SetupSamplerLinear(ID3D12GraphicsCommandList *command_list)
{
...
static void
ImGui_ImplDX12_SetupSamplerNearest(ID3D12GraphicsCommandList *command_list)
{
    ImGui_ImplDX12_Data *bd = ImGui_ImplDX12_GetBackendData();
...
// Draw callbacks
static void
ImGui_ImplDX12_DrawCallback_ResetRenderState(const ImDrawList *, const ImDrawCmd *)
{
} // Intentionally empty. Used as an identifier for rendering loop to call its code. Simpler to
  // implement this way.
static void
ImGui_ImplDX12_DrawCallback_SetSamplerLinear(const ImDrawList *, const ImDrawCmd *)
{
    ImGui_ImplDX12_Data *bd = ImGui_ImplDX12_GetBackendData();
    ImGui_ImplDX12_SetupSamplerLinear(bd->RenderState->CommandList);
}
static void
ImGui_ImplDX12_DrawCallback_SetSamplerNearest(const ImDrawList *, const ImDrawCmd *)
{
    ImGui_ImplDX12_Data *bd = ImGui_ImplDX12_GetBackendData();
    ImGui_ImplDX12_SetupSamplerNearest(bd->RenderState->CommandList);
}
...
ImGui_ImplDX12_RenderDrawData(ImDrawData *draw_data, ID3D12GraphicsCommandList *command_list)
{
    ...
    ImGui_ImplDX12_ViewportData *vd
        = (ImGui_ImplDX12_ViewportData *)draw_data->OwnerViewport->RendererUserData;
    ImGui_ImplDX12_RenderBuffers *fr
...
static void
ImGui_ImplDX12_DestroyTexture(ImTextureData *tex)
{
    if (ImGui_ImplDX12_Texture *backend_tex = (ImGui_ImplDX12_Texture *)tex->BackendUserData)
    {
        ...
        bd->InitInfo.SrvDescriptorFreeFn(
            &bd->InitInfo, backend_tex->hFontSrvCpuDescHandle, backend_tex->hFontSrvGpuDescHandle);
...
void
ImGui_ImplDX12_UpdateTexture(ImTextureData *tex)
{
    ImGui_ImplDX12_Data *bd = ImGui_ImplDX12_GetBackendData();
...
ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    bd->pdxgiFactory->CheckFeatureSupport(
...
static void
ImGui_ImplDX12_DestroyRenderBuffers(ImGui_ImplDX12_RenderBuffers *render_buffers)
{
...
static void
ImGui_ImplDX12_InitLegacySingleDescriptorMode(ImGui_ImplDX12_InitInfo *init_info)
{
                    ...
                    D3D12_GPU_DESCRIPTOR_HANDLE font_srv_gpu_desc_handle)
{
    ...
    ImGuiIO &io = ImGui::GetIO();
    io.BackendFlags &= ~ImGuiBackendFlags_RendererHasTextures; // Using legacy ImGui_ImplDX12_Init()
                                                               // call with 1 SRV descriptor we
                                                               // cannot support multiple textures.
...
static void
ImGui_ImplDX12_CreateWindow(ImGuiViewport *viewport)
{
    ImGui_ImplDX12_Data         *bd = ImGui_ImplDX12_GetBackendData();
    ...
    // handle (e.g. GLFWWindow*, SDL's WindowID). Some backends will leave PlatformHandleRaw == 0,
    // in which case we assume PlatformHandle will contain the HWND.
    ...
    // Create command list.
    res = bd->pd3dDevice->CreateCommandList(0,
                                            D3D12_COMMAND_LIST_TYPE_DIRECT,
    ...
    res = bd->pdxgiFactory->MakeWindowAssociation(
        hwnd, DXGI_MWA_NO_ALT_ENTER | DXGI_MWA_NO_WINDOW_CHANGES); // Disable e.g. Alt+Enter
    IM_ASSERT(res == S_OK);
    ...
    if (vd->SwapChain)
    {
        ...
        SIZE_T rtv_descriptor_size
            = bd->pd3dDevice->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_RTV);
...
static void
ImGui_WaitForPendingOperations(ImGui_ImplDX12_ViewportData *vd)
{
    ImGui_ImplDX12_Data *bd = ImGui_ImplDX12_GetBackendData();
...
static ImGui_ImplDX12_FrameContext *
ImGui_WaitForNextFrameContext(ImGui_ImplDX12_ViewportData *vd)
{
    ImGui_ImplDX12_Data         *bd = ImGui_ImplDX12_GetBackendData();
...
static void
ImGui_ImplDX12_DestroyWindow(ImGuiViewport *viewport)
{
...
static void
ImGui_ImplDX12_SetWindowSize(ImGuiViewport *viewport, ImVec2 size)
{
    ImGui_ImplDX12_Data         *bd = ImGui_ImplDX12_GetBackendData();
...
static void
ImGui_ImplDX12_RenderWindow(ImGuiViewport *viewport, void *)
{
    ImGui_ImplDX12_Data         *bd = ImGui_ImplDX12_GetBackendData();
    ImGui_ImplDX12_ViewportData *vd = (ImGui_ImplDX12_ViewportData *)viewport->RendererUserData;
    ...
    cmd_list->OMSetRenderTargets(
        1, &vd->FrameCtx[back_buffer_idx].RenderTargetCpuDescriptors, FALSE, nullptr);
    if (!(viewport->Flags & ImGuiViewportFlags_NoRendererClear))
    {
        cmd_list->ClearRenderTargetView(vd->FrameCtx[back_buffer_idx].RenderTargetCpuDescriptors,
...
static void
ImGui_ImplDX12_SwapBuffers(ImGuiViewport *viewport, void *)
{
    ImGui_ImplDX12_Data         *bd = ImGui_ImplDX12_GetBackendData();
    ImGui_ImplDX12_ViewportData *vd = (ImGui_ImplDX12_ViewportData *)viewport->RendererUserData;
