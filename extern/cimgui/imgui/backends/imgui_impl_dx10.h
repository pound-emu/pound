...
struct ImGui_ImplDX10_RenderState
{
    ...
    // ID3D10SamplerState*   SamplerLinear;          // Use
    // ImDrawList::AddCallback(ImGui::GetPlatform().DrawCallback_SetSamplerLinear)
    // ID3D10SamplerState*   SamplerNearest;         // Use
    // ImDrawList::AddCallback(ImGui::GetPlatform().DrawCallback_SetSamplerNearest)
};
