...
--------------------------header definitions
local cimgui_header = [[//This file is automatically generated by generator.lua from https://github.com/cimgui/cimgui
...
if gdefines.IMGUI_HAS_DOCK then
    gdefines.IMGUI_HAS_DOCK = true
end
if gdefines.IMGUI_HAS_IMSTR then
    gdefines.IMGUI_HAS_IMSTR = true
end
...
if #implementations > 0 then
    ...
    for i, impl in ipairs(implementations) do
        ...
        local extra_defines = ""
        if impl == "opengl3" then
            extra_defines = define_cmd .. "IMGUI_IMPL_OPENGL_LOADER_GL3W "
        end
        local include_cmd = COMPILER == "cl" and [[ /I ]] or [[ -I ]]
        local extra_includes = include_cmd .. " " .. IMGUI_PATH .. " "
        if config[impl] then
