...
{
    ImU32 Data[(ImGuiKey_NamedKey_COUNT + 31) >> 5];
...
CIMGUI_API void    igSetNextWindowSizeConstraints(const ImVec2_c    size_min,
                                                  const ImVec2_c    size_max,
...
CIMGUI_API void igImage(ImTextureRef_c tex_ref,
                        const ImVec2_c image_size,
                        const ImVec2_c uv0,
                        const ImVec2_c uv1);
CIMGUI_API void igImageWithBg(ImTextureRef_c tex_ref,
                              const ImVec2_c image_size,
                              const ImVec2_c uv0,
                              const ImVec2_c uv1,
                              const ImVec4_c bg_col,
                              const ImVec4_c tint_col);
...
CIMGUI_API ImGuiID igDockSpaceOverViewport(ImGuiID                 dockspace_id,
...
CIMGUI_API void                igPushClipRect(const ImVec2_c clip_rect_min,
                                              const ImVec2_c clip_rect_max,
...
CIMGUI_API void        ImGuiIO_SetKeyEventNativeData(
           ImGuiIO *self, ImGuiKey key, int native_keycode, int native_scancode, int native_legacy_index);
...
CIMGUI_API void ImGuiInputTextCallbackData_DeleteChars(ImGuiInputTextCallbackData *self,
                                                       int                         pos,
                                                       int                         bytes_count);
CIMGUI_API void ImGuiInputTextCallbackData_InsertChars(ImGuiInputTextCallbackData *self,
                                                       int                         pos,
                                                       const char                 *text,
                                                       const char                 *text_end);
...
CIMGUI_API void ImGuiSelectionBasicStorage_ApplyRequests(ImGuiSelectionBasicStorage *self,
...
CIMGUI_API void ImGuiSelectionBasicStorage_Swap(ImGuiSelectionBasicStorage *self,
                                                ImGuiSelectionBasicStorage *r);
CIMGUI_API void ImGuiSelectionBasicStorage_SetItemSelected(ImGuiSelectionBasicStorage *self,
                                                           ImGuiID                     id,
                                                           bool                        selected);
CIMGUI_API bool ImGuiSelectionBasicStorage_GetNextSelectedItem(ImGuiSelectionBasicStorage *self,
                                                               void   **opaque_it,
                                                               ImGuiID *out_id);
CIMGUI_API ImGuiID
ImGuiSelectionBasicStorage_GetStorageIdFromIndex(ImGuiSelectionBasicStorage *self, int idx);
...
CIMGUI_API void ImGuiSelectionExternalStorage_ApplyRequests(ImGuiSelectionExternalStorage *self,
                                                            ImGuiMultiSelectIO            *ms_io);
...
CIMGUI_API void        ImDrawList_AddLine(
           ImDrawList *self, const ImVec2_c p1, const ImVec2_c p2, ImU32 col, float thickness);
CIMGUI_API void ImDrawList_AddLineH(
    ImDrawList *self, float min_x, float max_x, float y, ImU32 col, float thickness);
CIMGUI_API void ImDrawList_AddLineV(
    ImDrawList *self, float x, float min_y, float max_y, ImU32 col, float thickness);
CIMGUI_API void ImDrawList_AddRect(ImDrawList    *self,
                                   const ImVec2_c p_min,
                                   const ImVec2_c p_max,
                                   ImU32          col,
                                   float          rounding,
                                   float          thickness,
                                   ImDrawFlags    flags);
...
CIMGUI_API void ImDrawList_AddTriangleFilled(
    ImDrawList *self, const ImVec2_c p1, const ImVec2_c p2, const ImVec2_c p3, ImU32 col);
...
CIMGUI_API void ImDrawList_AddCircleFilled(
    ImDrawList *self, const ImVec2_c center, float radius, ImU32 col, int num_segments);
...
CIMGUI_API void ImDrawList_AddText_Vec2(
    ImDrawList *self, const ImVec2_c pos, ImU32 col, const char *text_begin, const char *text_end);
...
CIMGUI_API void ImDrawList_AddImage(ImDrawList    *self,
                                    ...
                                    const ImVec2_c p_min,
                                    const ImVec2_c p_max,
                                    const ImVec2_c uv_min,
                                    const ImVec2_c uv_max,
                                    ImU32          col);
...
CIMGUI_API void ImDrawList_PathArcToFast(
    ImDrawList *self, const ImVec2_c center, float radius, int a_min_of_12, int a_max_of_12);
...
CIMGUI_API void ImDrawList_PathBezierCubicCurveTo(
    ImDrawList *self, const ImVec2_c p2, const ImVec2_c p3, const ImVec2_c p4, int num_segments);
CIMGUI_API void        ImDrawList_PathBezierQuadraticCurveTo(ImDrawList    *self,
                                                             const ImVec2_c p2,
                                                             const ImVec2_c p3,
                                                             int            num_segments);
CIMGUI_API void        ImDrawList_PathRect(ImDrawList    *self,
                                           const ImVec2_c rect_min,
                                           const ImVec2_c rect_max,
                                           float          rounding,
                                           ImDrawFlags    flags);
...
CIMGUI_API ImFont *ImFontAtlas_AddFontDefaultVector(ImFontAtlas        *self,
                                                    const ImFontConfig *font_cfg);
CIMGUI_API ImFont *ImFontAtlas_AddFontDefaultBitmap(ImFontAtlas        *self,
                                                    const ImFontConfig *font_cfg);
...
CIMGUI_API ImFont *ImFontAtlas_AddFontFromMemoryTTF(ImFontAtlas        *self,
                                                    void               *font_data,
                                                    int                 font_data_size,
                                                    float               size_pixels,
                                                    const ImFontConfig *font_cfg,
                                                    const ImWchar      *glyph_ranges);
CIMGUI_API ImFont *ImFontAtlas_AddFontFromMemoryCompressedTTF(ImFontAtlas *self,
...
CIMGUI_API ImFontAtlasRectId ImFontAtlas_AddCustomRect(ImFontAtlas     *self,
                                                       int              width,
                                                       int              height,
                                                       ImFontAtlasRect *out_r);
CIMGUI_API void              ImFontAtlas_RemoveCustomRect(ImFontAtlas *self, ImFontAtlasRectId id);
CIMGUI_API bool              ImFontAtlas_GetCustomRect(ImFontAtlas      *self,
...
CIMGUI_API ImVec2_c          ImFont_CalcTextSizeA(ImFont      *self,
                                                  float        size,
                                                  float        max_width,
                                                  float        wrap_width,
                                                  const char  *text_begin,
...
CIMGUI_API const char       *ImFont_CalcWordWrapPosition(
          ImFont *self, float size, const char *text, const char *text_end, float wrap_width);
...
CIMGUI_API void igImFormatStringToTempBuffer(const char **out_buf,
                                             ...
                                             ...);
#ifdef CIMGUI_VARGS0
CIMGUI_API void igImFormatStringToTempBuffer0(const char **out_buf,
                                              const char **out_buf_end,
                                              const char  *fmt);
#endif
...
CIMGUI_API const char  *igImTextFindPreviousUtf8Codepoint(const char *in_text_start,
                                                          const char *in_p);
CIMGUI_API const char  *igImTextFindValidUtf8CodepointEnd(const char *in_text_start,
                                                          const char *in_text_end,
                                                          const char *in_p);
CIMGUI_API int          igImTextCountLines(const char *in_text, const char *in_text_end);
CIMGUI_API ImVec2_c     igImFontCalcTextSizeEx(ImFont         *font,
                                               float           size,
                                               float           max_width,
                                               float           wrap_width,
                                               const char     *text_begin,
                                               ...
                                               ImVec2_c       *out_offset,
                                               ImDrawTextFlags flags);
CIMGUI_API const char  *igImFontCalcWordWrapPositionEx(ImFont         *font,
                                                       float           size,
                                                       const char     *text,
                                                       const char     *text_end,
                                                       float           wrap_width,
                                                       ImDrawTextFlags flags);
CIMGUI_API const char  *igImTextCalcWordWrapNextLineStart(const char     *text,
                                                          const char     *text_end,
                                                          ImDrawTextFlags flags);
CIMGUI_API void         igImTextInitClassifiers(void);
CIMGUI_API void         igImTextClassifierClear(ImU32       *bits,
                                                unsigned int codepoint_min,
                                                unsigned int codepoint_end,
                                                ImWcharClass char_class);
CIMGUI_API void         igImTextClassifierSetCharClass(ImU32       *bits,
                                                       unsigned int codepoint_min,
                                                       unsigned int codepoint_end,
                                                       ImWcharClass char_class,
                                                       unsigned int c);
CIMGUI_API void         igImTextClassifierSetCharClassFromStr(ImU32       *bits,
                                                              unsigned int codepoint_min,
                                                              unsigned int codepoint_end,
                                                              ImWcharClass char_class,
                                                              const char  *s);
...
CIMGUI_API ImVec2_c     igImBezierCubicCalc(
        const ImVec2_c p1, const ImVec2_c p2, const ImVec2_c p3, const ImVec2_c p4, float t);
CIMGUI_API ImVec2_c  igImBezierCubicClosestPoint(const ImVec2_c p1,
                                                 const ImVec2_c p2,
                                                 const ImVec2_c p3,
                                                 const ImVec2_c p4,
                                                 const ImVec2_c p,
                                                 int            num_segments);
CIMGUI_API ImVec2_c  igImBezierCubicClosestPointCasteljau(const ImVec2_c p1,
                                                          const ImVec2_c p2,
                                                          const ImVec2_c p3,
                                                          const ImVec2_c p4,
                                                          const ImVec2_c p,
                                                          float          tess_tol);
CIMGUI_API ImVec2_c  igImBezierQuadraticCalc(const ImVec2_c p1,
                                             const ImVec2_c p2,
                                             const ImVec2_c p3,
                                             float          t);
CIMGUI_API ImVec2_c  igImLineClosestPoint(const ImVec2_c a, const ImVec2_c b, const ImVec2_c p);
CIMGUI_API bool      igImTriangleContainsPoint(const ImVec2_c a,
                                               const ImVec2_c b,
                                               const ImVec2_c c,
                                               const ImVec2_c p);
CIMGUI_API ImVec2_c  igImTriangleClosestPoint(const ImVec2_c a,
                                              const ImVec2_c b,
                                              const ImVec2_c c,
                                              const ImVec2_c p);
CIMGUI_API void      igImTriangleBarycentricCoords(const ImVec2_c a,
                                                   const ImVec2_c b,
                                                   const ImVec2_c c,
                                                   const ImVec2_c p,
                                                   float         *out_u,
...
CIMGUI_API void ImDrawListSharedData_SetCircleTessellationMaxError(ImDrawListSharedData *self,
                                                                   float                 max_error);
...
CIMGUI_API float                  ImGuiMenuColumns_DeclColumns(
                     ImGuiMenuColumns *self, float w_icon, float w_label, float w_shortcut, float w_mark);
...
CIMGUI_API ImGuiListClipperRange    ImGuiListClipperRange_FromPositions(float y1,
                                                                        float y2,
                                                                        int   off_min,
                                                                        int   off_max);
...
CIMGUI_API ImVec2_c ImGuiViewportP_CalcWorkRectSize(ImGuiViewportP *self,
                                                    const ImVec2_c  inset_min,
                                                    const ImVec2_c  inset_max);
...
CIMGUI_API void igSetWindowParentWindowForFocusRoute(ImGuiWindow *window,
                                                     ImGuiWindow *parent_window);
...
CIMGUI_API void         igFindHoveredWindowEx(const ImVec2_c pos,
...
CIMGUI_API void         igTranslateWindowsInViewport(ImGuiViewportP *viewport,
                                                     const ImVec2_c  old_pos,
                                                     const ImVec2_c  new_pos,
                                                     const ImVec2_c  old_size,
                                                     const ImVec2_c  new_size);
...
CIMGUI_API ImGuiViewportP             *igFindHoveredViewportFromPlatformWindowStack(
                const ImVec2_c mouse_platform_pos);
...
CIMGUI_API ImVec2_c igScrollToRectEx(ImGuiWindow     *window,
                                     const ImRect_c   rect,
...
CIMGUI_API bool                 igItemAdd(const ImRect_c bb,
                                          ImGuiID        id,
                                          const ImRect  *nav_bb,
...
CIMGUI_API void     igShrinkWidths(ImGuiShrinkWidthItem *items,
                                   ...
                                   float                 width_excess,
                                   float                 width_min);
CIMGUI_API void     igCalcClipRectVisibleItemsY(const ImRect_c clip_rect,
                                                const ImVec2_c pos,
                                                float          items_height,
...
CIMGUI_API ImVec2_c         igFindBestWindowPosForPopupEx(const ImVec2_c           ref_pos,
                                                          const ImVec2_c           size,
                                                          ImGuiDir                *last_dir,
                                                          const ImRect_c           r_outer,
                                                          const ImRect_c           r_avoid,
...
CIMGUI_API ImVec2_c      igGetKeyMagnitude2d(ImGuiKey key_left,
                                             ImGuiKey key_right,
                                             ImGuiKey key_up,
                                             ImGuiKey key_down);
...
CIMGUI_API void           igDockContextProcessUndockWindow(ImGuiContext *ctx,
                                                           ImGuiWindow  *window,
...
CIMGUI_API void    igDockBuilderCopyDockSpace(ImGuiID                 src_dockspace_id,
...
CIMGUI_API void    igRenderDragDropTargetRectEx(ImDrawList    *draw_list,
                                                const ImRect_c bb,
                                                float          rounding);
...
CIMGUI_API int                       igTypingSelectFindMatch(ImGuiTypingSelectRequest *req,
                                                             ...
                                                             void *user_data,
                                                             int   nav_item_idx);
CIMGUI_API int  igTypingSelectFindNextSingleCharMatch(ImGuiTypingSelectRequest *req,
                                                      int                       items_count,
                                                      const char *(*get_item_name_func)(void *, int),
                                                      void *user_data,
                                                      int   nav_item_idx);
CIMGUI_API int  igTypingSelectFindBestLeadingMatch(ImGuiTypingSelectRequest *req,
                                                   int                       items_count,
                                                   const char *(*get_item_name_func)(void *, int),
                                                   void *user_data);
CIMGUI_API bool igBeginBoxSelect(const ImRect_c        scope_rect,
                                 ImGuiWindow          *window,
...
CIMGUI_API void        igTableDrawDefaultContextMenu(ImGuiTable     *table,
...
CIMGUI_API ImVec2_c      igTabItemCalcSize_Str(const char *label,
...
CIMGUI_API void          igRenderText(ImVec2_c    pos,
                                      const char *text,
                                      const char *text_end,
                                      bool        hide_text_after_hash);
CIMGUI_API void          igRenderTextWrapped(ImVec2_c    pos,
                                             const char *text,
                                             const char *text_end,
                                             float       wrap_width);
CIMGUI_API void          igRenderTextClipped(const ImVec2_c  pos_min,
                                             const ImVec2_c  pos_max,
                                             const char     *text,
                                             const char     *text_end,
                                             const ImVec2_c *text_size_if_known,
                                             const ImVec2_c  align,
                                             const ImRect   *clip_rect);
CIMGUI_API void          igRenderTextClippedEx(ImDrawList     *draw_list,
                                               const ImVec2_c  pos_min,
                                               const ImVec2_c  pos_max,
                                               const char     *text,
                                               const char     *text_end,
                                               const ImVec2_c *text_size_if_known,
...
CIMGUI_API void          igRenderTextEllipsis(ImDrawList     *draw_list,
                                              ...
                                              const char     *text_end,
                                              const ImVec2_c *text_size_if_known);
CIMGUI_API void          igRenderFrame(
             ImVec2_c p_min, ImVec2_c p_max, ImU32 fill_col, bool borders, float rounding);
...
CIMGUI_API void        igRenderMouseCursor(ImVec2_c         pos,
                                           float            scale,
                                           ImGuiMouseCursor mouse_cursor,
                                           ImU32            col_fill,
                                           ImU32            col_border,
                                           ImU32            col_shadow);
CIMGUI_API void        igRenderArrow(
           ImDrawList *draw_list, ImVec2_c pos, ImU32 col, ImGuiDir dir, float scale);
...
CIMGUI_API void igRenderArrowPointingAt(
    ImDrawList *draw_list, ImVec2_c pos, ImVec2_c half_sz, ImGuiDir direction, ImU32 col);
CIMGUI_API void igRenderArrowDockMenu(ImDrawList *draw_list, ImVec2_c p_min, float sz, ImU32 col);
CIMGUI_API void igRenderRectFilledInRangeH(ImDrawList    *draw_list,
                                           const ImRect_c rect,
                                           ImU32          col,
                                           float          fill_x0,
                                           float          fill_x1,
...
CIMGUI_API void igRenderRectFilledWithHole(
    ImDrawList *draw_list, const ImRect_c outer, const ImRect_c inner, ImU32 col, float rounding);
CIMGUI_API ImDrawFlags igCalcRoundingFlagsForRectInRect(const ImRect_c r_in,
                                                        const ImRect_c r_outer,
                                                        float          threshold);
...
CIMGUI_API bool     igScrollbarEx(const ImRect_c bb,
                                  ImGuiID        id,
                                  ImGuiAxis      axis,
                                  ImS64         *p_scroll_v,
                                  ImS64          avail_v,
...
CIMGUI_API void     igExtendHitBoxWhenNearViewportEdge(ImGuiWindow *window,
                                                       ImRect      *bb,
                                                       float        threshold,
                                                       ImGuiAxis    axis);
CIMGUI_API bool     igButtonBehavior(
        const ImRect_c bb, ImGuiID id, bool *out_hovered, bool *out_held, ImGuiButtonFlags flags);
CIMGUI_API bool igDragBehavior(ImGuiID          id,
                               ...
                               const char      *format,
                               ImGuiSliderFlags flags);
CIMGUI_API bool igSliderBehavior(const ImRect_c   bb,
                                 ImGuiID          id,
                                 ImGuiDataType    data_type,
                                 void            *p_v,
                                 const void      *p_min,
                                 ...
                                 ImGuiSliderFlags flags,
                                 ImRect          *out_grab_bb);
CIMGUI_API bool igSplitterBehavior(const ImRect_c bb,
                                   ImGuiID        id,
                                   ImGuiAxis      axis,
                                   float         *size1,
                                   float         *size2,
...
CIMGUI_API void igDataTypeApplyOp(
...
CIMGUI_API bool igTempInputText(const ImRect_c         bb,
                                ImGuiID                id,
                                const char            *label,
                                char                  *buf,
                                size_t                 buf_size,
                                ...
                                ImGuiInputTextCallback callback,
                                void                  *user_data);
CIMGUI_API bool igTempInputScalar(const ImRect_c bb,
                                  ImGuiID        id,
                                  const char    *label,
                                  ImGuiDataType  data_type,
                                  void          *p_data,
...
CIMGUI_API void  igShadeVertsLinearColorGradientKeepAlpha(ImDrawList *draw_list,
                                                          int         vert_start_idx,
                                                          int         vert_end_idx,
                                                          ImVec2_c    gradient_p0,
                                                          ImVec2_c    gradient_p1,
                                                          ImU32       col0,
                                                          ImU32       col1);
...
CIMGUI_API void  igShadeVertsTransformPos(ImDrawList    *draw_list,
                                          int            vert_start_idx,
                                          int            vert_end_idx,
                                          const ImVec2_c pivot_in,
                                          float          cos_a,
                                          float          sin_a,
                                          const ImVec2_c pivot_out);
...
CIMGUI_API void  igDebugNodeDrawList(ImGuiWindow      *window,
                                     ...
                                     const char       *label);
CIMGUI_API void  igDebugNodeDrawCmdShowMeshAndBoundingBox(ImDrawList       *out_draw_list,
                                                          const ImDrawList *draw_list,
...
CIMGUI_API void  igDebugNodeTexture(ImTextureData         *tex,
                                    int                    int_id,
...
CIMGUI_API void  igDebugNodeWindowsListByBeginStackParent(ImGuiWindow **windows,
                                                          int           windows_size,
...
CIMGUI_API void                igImFontAtlasBuildSetupFontLoader(ImFontAtlas        *atlas,
                                                                 const ImFontLoader *font_loader);
CIMGUI_API void                igImFontAtlasBuildNotifySetFont(ImFontAtlas *atlas,
                                                               ImFont      *old_font,
                                                               ImFont      *new_font);
CIMGUI_API void                igImFontAtlasBuildUpdatePointers(ImFontAtlas *atlas);
CIMGUI_API void                igImFontAtlasBuildRenderBitmapFromString(
...
CIMGUI_API void           igImFontAtlasBuildSetupFontSpecialGlyphs(ImFontAtlas  *atlas,
                                                                   ImFont       *font,
                                                                   ImFontConfig *src);
CIMGUI_API void           igImFontAtlasBuildLegacyPreloadAllGlyphRanges(ImFontAtlas *atlas);
CIMGUI_API void           igImFontAtlasBuildGetOversampleFactors(ImFontConfig *src,
                                                                 ImFontBaked  *baked,
...
CIMGUI_API void           igImFontAtlasFontSourceAddToFont(ImFontAtlas  *atlas,
                                                           ImFont       *font,
                                                           ImFontConfig *src);
...
CIMGUI_API ImGuiID      igImFontAtlasBakedGetId(ImGuiID font_id,
                                                float   baked_size,
                                                float   rasterizer_density);
CIMGUI_API ImFontBaked *igImFontAtlasBakedGetOrAdd(ImFontAtlas *atlas,
                                                   ImFont      *font,
                                                   float        font_size,
                                                   float        font_rasterizer_density);
CIMGUI_API ImFontBaked *igImFontAtlasBakedGetClosestMatch(ImFontAtlas *atlas,
                                                          ImFont      *font,
                                                          float        font_size,
                                                          float        font_rasterizer_density);
CIMGUI_API ImFontBaked *igImFontAtlasBakedAdd(ImFontAtlas *atlas,
                                              ImFont      *font,
                                              float        font_size,
                                              float        font_rasterizer_density,
                                              ImGuiID      baked_id);
CIMGUI_API void igImFontAtlasBakedDiscard(ImFontAtlas *atlas, ImFont *font, ImFontBaked *baked);
CIMGUI_API ImFontGlyph *igImFontAtlasBakedAddFontGlyph(ImFontAtlas       *atlas,
                                                       ImFontBaked       *baked,
                                                       ImFontConfig      *src,
                                                       const ImFontGlyph *in_glyph);
CIMGUI_API void         igImFontAtlasBakedAddFontGlyphAdvancedX(
            ImFontAtlas *atlas, ImFontBaked *baked, ImFontConfig *src, ImWchar codepoint, float advance_x);
CIMGUI_API void              igImFontAtlasBakedDiscardFontGlyph(ImFontAtlas *atlas,
                                                                ImFont      *font,
                                                                ImFontBaked *baked,
                                                                ImFontGlyph *glyph);
CIMGUI_API void              igImFontAtlasBakedSetFontGlyphBitmap(ImFontAtlas         *atlas,
                                                                  ImFontBaked         *baked,
                                                                  ImFontConfig        *src,
                                                                  ImFontGlyph         *glyph,
                                                                  ImTextureRect       *r,
...
CIMGUI_API ImFontAtlasRectId igImFontAtlasPackAddRect(ImFontAtlas          *atlas,
                                                      int                   w,
                                                      int                   h,
...
CIMGUI_API void              igImFontAtlasUpdateNewFrame(ImFontAtlas *atlas,
                                                         int          frame_count,
                                                         bool         renderer_has_textures);
CIMGUI_API void igImFontAtlasAddDrawListSharedData(ImFontAtlas *atlas, ImDrawListSharedData *data);
CIMGUI_API void igImFontAtlasRemoveDrawListSharedData(ImFontAtlas          *atlas,
                                                      ImDrawListSharedData *data);
CIMGUI_API void igImFontAtlasUpdateDrawListsTextures(ImFontAtlas   *atlas,
                                                     ImTextureRef_c old_tex,
                                                     ImTextureRef_c new_tex);
CIMGUI_API void igImFontAtlasUpdateDrawListsSharedData(ImFontAtlas *atlas);
CIMGUI_API void igImFontAtlasTextureBlockConvert(const unsigned char *src_pixels,
                                                 ImTextureFormat      src_fmt,
                                                 int                  src_pitch,
...
CIMGUI_API void igImFontAtlasTextureBlockPostProcessMultiply(ImFontAtlasPostProcessData *data,
                                                             float multiply_factor);
CIMGUI_API void igImFontAtlasTextureBlockFill(
    ImTextureData *dst_tex, int dst_x, int dst_y, int w, int h, ImU32 col);
CIMGUI_API void igImFontAtlasTextureBlockCopy(ImTextureData *src_tex,
                                              int            src_x,
                                              int            src_y,
                                              ...
                                              int            w,
                                              int            h);
CIMGUI_API void igImFontAtlasTextureBlockQueueUpload(
...
CIMGUI_API void ImGuiFreeType_SetAllocatorFunctions(void *(*alloc_func)(size_t sz, void *user_data),
                                                    void (*free_func)(void *ptr, void *user_data),
                                                    void *user_data);
CIMGUI_API bool ImGuiFreeType_DebugEditFontLoaderFlags(
...
CIMGUI_API void ImGuiPlatformIO_Set_Platform_GetWindowPos(ImGuiPlatformIO *platform_io,
                                                          void (*user_callback)(ImGuiViewport *vp,
                                                                                ImVec2 *out_pos));
CIMGUI_API void ImGuiPlatformIO_Set_Platform_GetWindowSize(ImGuiPlatformIO *platform_io,
                                                           void (*user_callback)(ImGuiViewport *vp,
                                                                                 ImVec2 *out_size));
#endif
